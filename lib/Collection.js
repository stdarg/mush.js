/**
 * @fileOverview The Collection class is a base class for GameDataCollection, PlayerCollection, and
 ...
 * @param {function} cb The callback to execute upon completion with an error or a bool, true if empty.
 */
