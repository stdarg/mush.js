/**
 * @fileOverview The CmdQueue object is a queue of all user commands to be exectued. The commands
...
/**
 * queCmd allows objects to place player commands on the queue to be
...
CmdQueue.prototype.queCmd = function(conn, cmdStr) {
    ...
    cmdEntry.origCmdStr = new String(cmdStr);   // original string for error messages
