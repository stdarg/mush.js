...
var is = require('is2');
var PlayerCollection = require('./PlayerData').PlayerCollection;
var GameDataCollection = require('./GameData').GameDataCollection;
var ObjectCollection = require('./ObjectData').ObjectCollection;
...
function main() {
    ...
    global.logger = MushUtils.createGlobalLogger();
