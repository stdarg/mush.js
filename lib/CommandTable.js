...
function CommandTable() {
    ...
    this._addCmd('create',  2, Commands.prototype.create,  noConPlayer,  yesDconPlayer, shortAliases);
 ...
 */
CommandTable.prototype._addCmd = function(name, numArgs, funcHandler, connectedCmd, disconnectedCmd, makeShortAliases) {
...
CommandTable.prototype._makeAlias = function(cmdName, aliasName) {
    if (is.obj(cmdTab[aliasName]))
        return;
    log.info('Adding alias for \'%s\' as \'%s\'', cmdName, aliasName);
