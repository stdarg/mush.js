...
// FIXME modify addCmd to iteratively add abreviations until there is a colision.
...
CommandTable.prototype.get = function(name) {
    assert.ok(is.nonEmptyStr(name));
    //log.info('CommandTable.get name: '+name);
    //log.info('CmdTab name: '+util.inspect(cmdTab[name]));
